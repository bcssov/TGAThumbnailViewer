...
namespace Paloma
{
...

    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TargaImage"/> class.
        /// </summary>
        /// <param name="stream">The stream.</param>
        /// <exception cref="System.Exception">@Error loading file, could not read file from disk.</exception>
        public TargaImage(Stream stream) : this()
        {
            using (stream)
            {
                if (stream != null && stream.Length > 0 && stream.CanSeek == true)
                {
                    // create a BinaryReader used to read the Targa file
